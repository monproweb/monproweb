...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        
        {
            ...
            "sampleUtterances": [
                ...
                "Réserver un développeur",
            
                "Réserver un developer",
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Quel est le nom de votre projet ?",
    ...
    let botName = "BenderTordeurRodriguez";
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "136b8732",
